#!/usr/bin/python3
"""
The module in this file contains the HBNBCommand class that executes
...
class HBNBCommand(cmd.Cmd):
    """
    HBNBCommand class that executes the command interpreter.
    ...
    Methods:
        ...
        emptyline(self): Empty line + ENTER shouldn't execute/implement anything
    ...
    def do_create(self, arg):
        """
        Creates new instance of any available model
    ...
    def do_all(self, arg):
        """
        Prints all the string representation of all instances based or not
        on the class name.
    ...
    def do_update(self, arg):
        ...
        Update to the attribute (save the change into the JSON file).
